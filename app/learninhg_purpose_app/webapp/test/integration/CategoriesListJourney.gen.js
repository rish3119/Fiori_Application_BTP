...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("CategoriesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheCategoriesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheCategoriesListGenerated.onFilterBar().iChangeSearchField("Search Term");
